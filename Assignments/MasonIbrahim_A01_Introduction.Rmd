...
> Answer: I have taken a class in managing environmental data in R, using different packages. I also used Github. I used both R and Github for my undergraduate research project, completing data analytics for my data over the course of a couple of years.

2. Are there any components of the course about which you feel confident?

> Answer: I feel confident about using the system, as I have had alot of expereince working in these environments.

3. Are there any components of the course about which you feel apprehensive?

> Answer: I am less confident about remembering different commands and knowing how to trouble shoot when I run into errors.
...
> Answer: https://github.com/masonmarine/EDE_Fall2024
