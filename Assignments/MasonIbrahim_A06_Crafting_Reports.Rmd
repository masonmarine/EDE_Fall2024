...
```{r project.setup, echo=T, message=FALSE, warning=FALSE}
#Import libraries
library(tidyverse)
library(lubridate)
library(here)
...
```{r echo=FALSE, fig.cap= "2018 monthly Ozone levels", message=FALSE, warning=FALSE, fig.align="left", fig.height=3}
#Set months as Abb
...
```
```{r echo=FALSE, fig.cap= "2019 monthly Ozone levels", message=FALSE, warning=FALSE, fig.align="left", fig.height=3}
#Make Boxplot
epa_data %>%
  filter(Year == "2019") %>%
  ggplot(aes(x = Month,
...
https://github.com/masonmarine/EDE_Fall2024
