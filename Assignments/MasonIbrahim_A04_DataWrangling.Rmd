...
#1c 
df_air_o3_2018 <- 
  read.csv("~/R/EDE_Fall2024/Data/Raw/EPAair_O3_NC2018_raw.csv",
                           stringsAsFactors = TRUE)
df_air_o3_2019 <- 
  read.csv("~/R/EDE_Fall2024/Data/Raw/EPAair_O3_NC2019_raw.csv",
                           stringsAsFactors = TRUE)
df_air_pm25_2018 <-
  read.csv("~/R/EDE_Fall2024/Data/Raw/EPAair_PM25_NC2018_raw.csv",
                            stringsAsFactors = TRUE)
df_air_pm25_2019 <- 
  read.csv("~/R/EDE_Fall2024/Data/Raw/EPAair_PM25_NC2019_raw.csv",
                             stringsAsFactors = TRUE)
...
#6
write.csv(df_air_o3_2018, row.names = FALSE, 
          file = "~/R/EDE_Fall2024/Data/Processed/EPAair_O3_NC2018_processed.csv")
write.csv(df_air_o3_2019, row.names = FALSE, 
          file = "~/R/EDE_Fall2024/Data/Processed/EPAair_O3_NC2019_processed.csv")
write.csv(df_air_pm25_2018, row.names = FALSE, 
          file = "~/R/EDE_Fall2024/Data/Processed/EPAair_PM25_NC2018_processed.csv")
write.csv(df_air_pm25_2019, row.names = FALSE, 
          file = "~/R/EDE_Fall2024/Data/Processed/EPAair_PM25_NC2019_processed.csv")
...
#7
df_air_complete <- 
  rbind(df_air_o3_2018, df_air_o3_2019, df_air_pm25_2018, df_air_pm25_2019)
...
#11
write.csv(df_air_pm25_2019, row.names = FALSE,
          file = "~/R/EDE_Fall2024/Data/Processed/EPAair_O3_PM25_NC1819_Processed.csv")
```
