...
NTL.phys.data.tues <- filter (NTL.phys.data, year4 %in% c(1990:1999) 
...
NTL.phys.data.tues.july <- NTL.phys.data %>% 
...
NTL.phys.data.mean.temp <- NTL.phys.data.tues.july %>% 
  filter(depth == 0) %>% 
